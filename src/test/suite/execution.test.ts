...
// import { JavaScriptKernel } from '../../extension/kernel/jsKernel';
// import { Controller } from '../../extension/kernel';
...
//     });
//     [false].forEach((supportsExceptionBreakpoints) => {
...
//                     const kernel = JavaScriptKernel.getOrCreate(nb, Controller.typeScriptNotebookController);
//                     kernel.runCell(task, _token)
