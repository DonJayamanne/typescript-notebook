...
//         };
//     }
//     private displayHtml(html: string) {
//         this.notifyDisplay({ type: 'html', value: html });
//     }
//     // eslint-disable-next-line @typescript-eslint/ban-types
//     private displayJson(json: string | Object) {
//         this.notifyDisplay({ type: 'json', value: json, json: typeof json === 'string' ? JSON.parse(json) : json });
//     }
...
// export async function runCodeSilently(code: string | CodeObject): Promise<any> {
...
//         sendMessage(execResult);
//     } finally {
//         await DanfoJsFormatter.initialize(runCodeSilently);
//     }
// }
